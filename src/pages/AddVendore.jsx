...
function AddVendor() {
  ...
  const [form, setForm] = useState({
    ...
    zip: '',
    country: 'India',
    vendorType: 'supplier', // supplier/manufacturer/distributor
    taxId: '',
    accountNumber: '',
    ifscCode: '',
    notes: '',
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editMode) {
        await axios.put(`/api/vendors/${currentVendorId}`, form);
 ...
 const filteredVendors = Array.isArray(vendors)
  ...
  return (
    <div className="av-page-container">
      ...
      <div className="av-vendor-list-container">
        ...
        {isLoading && vendors.length === 0 ? (
          ...
          <div className="av-table-container">
            ...
            {filteredVendors.length === 0 && (
              <div className="av-no-results">No vendors found</div>
            )}
          </div>
        )}
      </div>
